...
var translations = map[string]map[string]string{
	"ru": {
		...
		"register.acceptTermsPre":  "Я принимаю",
		"register.termsLink":       "Пользовательское соглашение",
		"register.and":             "и",
		"register.privacyLink":     "Политику конфиденциальности",
		"register.acceptPdn":       "Даю согласие на обработку персональных данных, включая ИИН, в целях записи на приём и ведения истории обследований",

		"err.fillFullName":         "Заполните ФИО",
		"err.mustAcceptTerms":      "Нужно принять Пользовательское соглашение и Политику конфиденциальности",
		"err.mustAcceptPdn":        "Нужно дать согласие на обработку персональных данных",
	...
	"kz": {
		...
		"register.acceptTermsPre":  "Мен қабылдаймын",
		"register.termsLink":       "Пайдаланушы келісімін",
		"register.and":             "және",
		"register.privacyLink":     "Құпиялылық саясатын",
		"register.acceptPdn":       "Қабылдауға жазылу және тексеру тарихын жүргізу мақсатында ЖСН қоса алғанда, дербес деректерімді өңдеуге келісім беремін",

		"err.fillFullName":         "Аты-жөнін толтырыңыз",
		"err.mustAcceptTerms":      "Пайдаланушы келісімі мен Құпиялылық саясатын қабылдау керек",
		"err.mustAcceptPdn":        "Дербес деректерді өңдеуге келісім беру керек",
	...
	"en": {
		...
		"register.acceptTermsPre":  "I accept the",
		"register.termsLink":       "Terms of Use",
		"register.and":             "and",
		"register.privacyLink":     "Privacy Policy",
		"register.acceptPdn":       "I consent to the processing of my personal data, including my national ID (IIN), for booking appointments and keeping a visit/test history",

		"err.fillFullName":         "Please fill in your full name",
		"err.mustAcceptTerms":      "You need to accept the Terms of Use and Privacy Policy",
		"err.mustAcceptPdn":        "You need to consent to personal data processing",
